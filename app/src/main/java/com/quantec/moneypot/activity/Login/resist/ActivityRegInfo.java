...
import com.quantec.moneypot.activity.Login.Model.dModel.FidoTokenData;
...
import com.quantec.moneypot.dialog.DialogClosedSMS;
import com.quantec.moneypot.dialog.DialogFidoCancle;
import com.quantec.moneypot.dialog.DialogFidoFinger;
...
import com.quantec.moneypot.databinding.ActivityRegInfoBinding;
import com.quantec.moneypot.util.NetworkStateCheck.NetworkStateCheck;
import com.quantec.moneypot.util.Permissions.PermissionFido;
...
public class ActivityRegInfo extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dp = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 80, dm);

        unregistrar = KeyboardVisibilityEvent.registerEventListener(this, new KeyboardVisibilityEventListener() {
            @Override
            public void onVisibilityChanged(boolean isOpen) {
                if(isOpen){
                    regInfoBinding.scrollView.post(new Runnable() {
                        @Override public void run() {
                            regInfoBinding.scrollView.smoothScrollBy(0, (int)dp);
                        }
                    });
                }
            }
...
//            actFinish();
    ...
    private View.OnClickListener backOkListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            Intent intent = new Intent(ActivityRegInfo.this, ActivityResistIntro.class);
            startActivity(intent);
//            actFinish();
