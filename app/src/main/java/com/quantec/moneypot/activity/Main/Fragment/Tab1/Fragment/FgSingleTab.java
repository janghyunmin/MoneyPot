...
public class FgSingleTab extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 11.04, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", -1.76, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", -6.31, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 61.11, MoneyFormatToWon.moneyFormatToWon(15000), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 1, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 1, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 1, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 1, MoneyFormatToWon.moneyFormatToWon(659483), 0));
        modelSingleTabs.add(new ModelSingleTab("", "스타벅스", "AA", 1, MoneyFormatToWon.moneyFormatToWon(659483), 0));
    ...
    private View.OnClickListener m1BtListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            adapterSingleTab.notifyItemChanged(0);
        }
    };
    ...
    private View.OnClickListener m6BtListener = new View.OnClickListener() {
        public void onClick(View v) {
            modelSingleTabs.get(0).setFilter("6개월 수익률");
            number = "3";
            dialogYieldFilter.dismiss();
