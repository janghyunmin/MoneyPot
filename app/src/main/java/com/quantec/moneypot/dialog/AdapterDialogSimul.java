...
public class AdapterDialogSimul extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterDialogSimul(ArrayList<ModelSimulList> modelSimulLists, Context context) {
