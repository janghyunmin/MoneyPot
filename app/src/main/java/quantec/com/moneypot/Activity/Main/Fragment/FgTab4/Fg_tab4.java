...
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.Footer.LoadingView;
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.RefreshListenerAdapter;
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.TwinklingRefreshLayout;
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.header.SinaRefreshView;
...
public class Fg_tab4 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SinaRefreshView headerView = new SinaRefreshView(mainActivity);
        headerView.setArrowResource(R.drawable.anim_loading_view);
        headerView.setTextColor(0xff745D5C);
        tab4Binding.refresh.setHeaderView(headerView);

        LoadingView loadingView = new LoadingView(mainActivity);
