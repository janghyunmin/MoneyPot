package quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.header;
...
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.IHeaderView;
import quantec.com.moneypot.Activity.Main.Fragment.FgTab4.tkrefreshlayout.OnAnimEndListener;
        ...
        for (int i = 0; i < num; i++) {
            if (animating) {
                switch (i) {
                    ...
                    case 0:
                        mPath.setAlpha(105);
                        mPath.setColor(getResources().getColor(R.color.button_able_text));
