...
import quantec.com.moneypot.databinding.ActivityChangedPwBinding;
...
public class ActivityChangedPw extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(ActivityChangedPw.this, R.layout.activity_changed_pw);
        binding.setChangerPw(this);
