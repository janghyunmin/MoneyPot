...
import quantec.com.moneypot.Activity.Search.SearchedPage.Adapter.AdapterDescTab;
...
public class FgDescTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterDescPage = new AdapterDescTab(postDescItemModels, getContext());
