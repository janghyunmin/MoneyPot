package quantec.com.moneypot.Activity.SearchPort.SearchedPage.Fragment.TitlePageTab;
...
import quantec.com.moneypot.Activity.SearchPort.SearchedPage.Fragment.TitlePageTab.Adapter.AdapterTitlePage;
...
public class Fg_TitlePageTab extends Fragment {
    ...
    AdapterTitlePage adapterTitlePage;
    ...
    public Fg_TitlePageTab() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fg_activitysearch_titlepagetab, container, false);
        ...
        adapterTitlePage = new AdapterTitlePage(postTitleItemModels, getContext());
